...
import './Accelerator11/AcceleratorDatasetTCSRI1.js';  // Adjusted import path to Radar11 folder

class Accelerator1 extends React.Component {
    constructor() {
        super();
        this.state = {
            items: [],
                        ...
                        {this.filteredItems().map((item, index) => (
                            <div key={index} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px', borderBottom: '1px solid #ccc' }}>
                                ...
                                <div style={{ marginLeft: 'auto' }}>
                                    {item.name === "Dataset 1" ? (
                                        <Link
                                            to={`/AcceleratorDatasetTCSRI1.js`}
