...
import "./SignalAnalysis3.js";
import "./SignalAcquisition3.js";

export default function TCSButton() {
  return (
            ...
            <div className="col-md-6 d-flex justify-content-center">
              <div className="card" style={{ width: "18rem" }}>
                <div className="card-body">
                  ...
                  <Link to="/SignalAnalysis3.js">View Details</Link>
                </div>
              </div>
            </div>
            <div className="col-md-6 d-flex justify-content-center">
              <div className="card" style={{ width: "18rem" }}>
                <div className="card-body">
                  ...
                  <Link to="/SignalAcquisition3.js">View Details</Link>
                </div>
              </div>
            </div>
          </div>
